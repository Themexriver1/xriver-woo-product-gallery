...
class Gallery{
    ...
    public function frontend_scripts(){
        ...
        $skeyboard = ('1' == $this->woospg_options['st_keyboard']) ? 'true' : 'false';
        $mousewheel = ('1' == $this->woospg_options['mousewheel']) ? 'true' : 'false';
        $sthumbnail = $this->woospg_options['st_disable_thumbnail'];
        $st_navigation = $this->woospg_options['st_navigation'];
        $sst_pagination = $this->woospg_options['st_pagination'];
        $spaceBetween = !empty($this->woospg_options['st_spaceBetween']) ? $this->woospg_options['st_spaceBetween'] : 15;
        $sspeed = !empty($this->woospg_options['st_speed']) ? $this->woospg_options['st_speed'] : '';
